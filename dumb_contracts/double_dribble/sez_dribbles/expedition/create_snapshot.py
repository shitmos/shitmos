...
# Input variables
input_file = 'snapshot_2024-09-27.txt'  # Name of the text file containing wallet addresses
output_file = 'expedition_snapshot_2024-09-27.json'  # Name of the output JSON file
